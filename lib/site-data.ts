...
export const siteSettings = {
  ...
  heroSubtitle:
    "I create AI-assisted ads, social reels, and polished brand edits that feel intentional, not templated.",
  heroComments: [
...
export const aboutProfile: AboutProfile = {
  ...
  toolkit: [
    {
      name: "Freepik Spaces",
      sub: "Moodboards, concept frames, and visual direction building",
      icon: "/tool-icons/freepik-spaces.png",
    },
    {
      name: "HeyGen",
      sub: "Avatar videos, voice sync, and fast presenter delivery",
      icon: "/tool-icons/heygen.png",
    },
    {
      name: "Synthesia",
      sub: "Scripted AI presenters for explainers and training content",
      icon: "/tool-icons/synthesia.png",
    },
    {
      name: "HiggsField",
      sub: "Stylized AI shots, motion tests, and scene exploration",
      icon: "/tool-icons/higgsfield.png",
    },
    {
      name: "Kling",
      sub: "Generative video clips with cinematic movement and detail",
      icon: "/tool-icons/kling.png",
    },
    {
      name: "Veo 3.1",
      sub: "High-fidelity AI video concepts and premium prompt-led scenes",
      icon: "/tool-icons/veo-3-1.png",
    },
  ],
  gallery: [
    {
